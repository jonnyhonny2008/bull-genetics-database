...
const flatStats = (level = 3000, sd = 50): TraitStats => ({
  ...
  // q: null → the normal approximation is used, which these tests exercise.
  byKind: {
    interim: { mean: 0, sd, n: 100, q: null },
    official: { mean: 0, sd, n: 100, q: null },
    april: { mean: 0, sd, n: 100, q: null },
  },
